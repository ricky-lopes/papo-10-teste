        ...
        >
          <div className="min-h-screen flex items-center justify-center p-4 md:p-6">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              className="bg-neutral-900 rounded-2xl max-w-5xl w-full border border-neutral-800 relative"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Botão de Fechar - Fixo no topo direito */}
              <button
                onClick={() => setSelectedProduct(null)}
                className="absolute top-4 right-4 z-10 bg-neutral-800 hover:bg-neutral-700 text-white rounded-full w-10 h-10 flex items-center justify-center transition-colors shadow-lg"
                aria-label="Fechar"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
              ...
              <div className="p-4 md:p-6 border-b border-neutral-800">
                <h2 className="text-xl md:text-2xl font-bold pr-12">{selectedProduct.name}</h2>
              </div>
              ...
              <div className="p-4 md:p-6 grid md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="flex flex-col">
                  <div className="mb-6">
                    ...
                    <p className="text-3xl md:text-4xl font-bold mb-6">R$ {selectedProduct.price.toFixed(2)}</p>
